...
export class DocumentIndexingService {
  ...
  static async processDocument(doc: DocumentInput): Promise<ProcessedDocument> {
  ...
  static async storeVectors(
    ...
    console.warn('DocumentIndexingService.storeVectors is deprecated. Use VectorStorageService for better performance.');
